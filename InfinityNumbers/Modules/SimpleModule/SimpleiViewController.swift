...
final class SimpleiViewController: BaseViewController {
    
    private let viewModel: SimpleViewModelProtocol
    ...
    required init(viewModel: SimpleViewModelProtocol) {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        tabBarController?.navigationItem.title = "Simple numbers"
    }
